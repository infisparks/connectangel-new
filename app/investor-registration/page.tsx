// app/investor-registration/page.tsx
...
import { InvestorMultiStepForm } from "./investorMultiStepForm"; // Adjust this path if needed
import { toast } from "sonner"; // For notifications

/**
 * Renders the Investor Registration Page.
 * This is a client component responsible for fetching the user ID
 * and then rendering the multi-step investor form.
 */
export default function InvestorRegistrationPage() {
  ...
  useEffect(() => {
    async function getSession() {
      ...
      if (data?.session) {
        ...
        toast.info("Please log in to register your investor profile.");
  ...
  return (
    <InvestorMultiStepForm userId={userId} />
  );
}
