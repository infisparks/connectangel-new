...
// Assuming you have a data file like this
...
export default function CategoriesSection() {
  ...
  const handleExploreClick = () => {
    router.push("/categories") // Changed from /countries
  }
  ...
  // Combine categories for infinite scroll effect
            ...
            >
              {loopedCategories.map(({ name, image }, idx) => (
                <motion.div
                  ...
                  data-original-index={idx % categories.length}
                  // 👇 **BOX STYLES UPDATED HERE**
