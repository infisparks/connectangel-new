...
export default function CategoriesSection() {
  ...
  return (
    // FIX: Changed background to solid color and removed gradient/overflow-hidden
    <section className="relative py-12 lg:py-16 bg-[#1B0E2B]">
      {/* Background Effects (REMOVED: Grid overlay and background animation) */}
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex flex-col gap-8 lg:gap-10">
          ...
          <div className="text-center space-y-4">
            ...
            <h2
              className="font-black text-white text-3xl lg:text-5xl xl:text-6xl leading-tight tracking-tight"
          ...
          <div>
            ...
            <div className="hidden lg:grid lg:grid-cols-4 gap-5 py-2">
            ...
            <div
              ref={scrollRef}
              className="lg:hidden flex overflow-x-auto gap-4 pt-4 pb-4 snap-x snap-mandatory"
              style={{
                scrollbarWidth: "none",
          ...
          >
            <Button
              ...
              className="group relative px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold text-base rounded-xl transition-all duration-300 shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-[1.03]"
              style={{ fontFamily: "Inter, system-ui, sans-serif" }}
            >
