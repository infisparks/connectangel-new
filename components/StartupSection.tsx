...
// Dummy data for the startups, makes it easy to add more later
const startups = [
  {
    name: "HSEC Services",
    country: "Indonesia",
    imageUrl: "https://placehold.co/292x176/332244/ffffff?text=HSEC",
    flagUrl: "https://placehold.co/17x17/ff0000/ffffff?text=I",
  },
  {
    name: "Baker Hughes",
    country: "Bahrain",
    imageUrl: "https://placehold.co/292x176/4a3a5a/ffffff?text=Baker+Hughes",
    flagUrl: "https://placehold.co/17x17/c42a35/ffffff?text=B",
    tag: "Kalsekar Incubation Centre",
  },
  {
    name: "Al Nasr Contracting",
    country: "Serbia",
    imageUrl: "https://placehold.co/292x176/554466/ffffff?text=Al+Nasr",
